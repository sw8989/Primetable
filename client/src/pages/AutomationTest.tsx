    ...
    <div className="container mx-auto py-8">
      ...
      <Tabs defaultValue="booking" className="w-full">
        <TabsList className="grid w-full grid-cols-2">
          <TabsTrigger value="booking">Booking Automation</TabsTrigger>
          <TabsTrigger value="search">Web Search</TabsTrigger>
        </TabsList>
        
        <TabsContent value="booking" className="mt-6">
          <h2 className="text-2xl font-semibold mb-4">OpenTable Booking Automation</h2>
          <p className="text-muted-foreground mb-6">
            Test our automated booking system on OpenTable and other restaurant reservation platforms.
          </p>
